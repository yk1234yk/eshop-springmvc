                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="dashboard_menu">
                            <ul class="nav nav-tabs border-0 flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"
                                       href="${pageContext.request.contextPath}/account/orderlist&id=${id}">
                                        我的订单</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active"
                                       href="${pageContext.request.contextPath}/account/viewUser/${userId}">
                                        账号信息</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 mt-5 mt-lg-0 mt-md-0">
                        <div class="dashboard_content">
                            <div class="tab-pane" id="account-detail" role="tabpanel"
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label>生日 : <fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd"/></label>
                                            </div>
                                            <div class="col-md-12">
                                                <a href="${pageContext.request.contextPath}/account/editUser/${user.id}" class="btn btn-primary">修改</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
