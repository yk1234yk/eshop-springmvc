...
<div class="page-wrapper">
    ...
    <div class="page-content">
                                            ...
                                            <table class="table">
                                                ...
                                                <c:forEach var="address" items="${addressList}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/account/editAddress/${address.id}"
                                                               class="btn btn-fill-out btn-sm">修改</a>
                                                            <a href="${pageContext.request.contextPath}/account/deleteAddress/${address.id}"
                                                               class="btn btn-fill-out btn-sm"
                                                               data-original-title="不进行确认，直接删除"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input required class="form-control"
                                                                       name="consigneePhone" type="text">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label>收货邮编 <span class="required">*</span></label>
                                                                <input required class="form-control" name="postcode"
                                                                       type="text">
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <!-- "收货地址详情" 模态框（Modal） -->
        <div class="modal fade" id="addressDetailModal" tabindex="-1" role="dialog"
             aria-labelledby="addressDetailModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label>收货人姓名</label>
                                <input readonly class="form-control" name="consigneeName" type="text"
                                       value="${address.consigneeName}">
                            </div>
                            <div class="form-group col-md-12">
                                <label>收货地址</label>
                                <input readonly class="form-control" name="consigneeAddress" type="text"
                                       value="${address.consigneeAddress}">
                            </div>
                            <div class="form-group col-md-12">
                                <label>收货手机号</label>
                                <input readonly class="form-control" name="consigneePhone" type="text"
                                       value="${address.consigneePhone}">
                            </div>
                            <div class="form-group col-md-12">
                                <label>收货邮编</label>
                                <input readonly class="form-control" name="postcode" type="text"
