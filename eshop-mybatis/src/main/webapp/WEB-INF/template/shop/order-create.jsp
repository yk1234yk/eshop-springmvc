            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 mt-5 mt-lg-0">
                        <form class="row" action="${pageContext.request.contextPath}/order/complete" method="post">
                                    ...
                                    <ul class="list-unstyled">
                                        <c:forEach var="cartItem" items="${cart.cartItemList}">
                                            <li class="mb-3 border-bottom pb-3 d-flex">
                                                <span class="mr-auto"> ${cartItem.product.name}</span>
                                                <span>x ${cartItem.quantity} </span> <span>${cartItem.total}</span>
                                            </li>
                                        </c:forEach>
